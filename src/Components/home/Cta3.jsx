...
const Cta3 = () => {
  return (
    ...
    >
      ...
      >
        <div className="w-[92.666667%] md:w-4/4 bg-[#000048]/80 backdrop-blur-md p-5 shadow-lg">
          <div className="text-left text-white">
            <h2 className="text-xl md:text-3xl font-bold font-raleway mb-2">
              Building Websites with Purpose and Performance
            </h2>
            <p className="text-sm md:text-md font-raleway mb-3 opacity-80">
